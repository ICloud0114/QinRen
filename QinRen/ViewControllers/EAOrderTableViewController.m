...
@interface EAOrderTableViewController ()

@end

@implementation EAOrderTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch ([self.type integerValue])
    {
        ...
        case 102:
        {
            UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"receive" forIndexPath:indexPath];
