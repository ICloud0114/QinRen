...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
     //   _faceView = [[FaceViewController alloc]initWithFrame:CGRectMake(0, 0, WIDTH, self.frame.size.height-44)];
        _faceView = [[FaceViewController alloc]initWithFrame:CGRectMake(0, 0, WIDTH, self.frame.size.height-44)];
        [self addSubview:_faceView];
        _faceView.hidden   = NO;
        
        _gifView = [[gifViewController alloc]initWithFrame:CGRectMake(0, 0, WIDTH, self.frame.size.height-44)];
        ...
        [_tb initWithFrame:CGRectMake(0, self.frame.size.height-44, WIDTH, 44)];
