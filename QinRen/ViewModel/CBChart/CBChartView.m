...
+(instancetype)charView
{
    ...
    // 默认值
//    chartView.frame = CGRectMake(10, 70, 300, 200);
    chartView.frame = CGRectMake(10, 70, [UIScreen mainScreen].bounds.size.width>320?400:300, [UIScreen mainScreen].bounds.size.height>568?550:400);
    return chartView;
}
...
{
    CGRect myRect = CGRectMake(0, self.height - bottomLineMargin + 5 , self.leftLineMargin, bottomLineMargin);
